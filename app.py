...
FEATURE_VALUE_MAPPING = {
    ...
    'Outcome': {0: 'Not Early Death', 1: 'Early Mortality'}
}
    ...
    with col_result:
        ...
        if not run_btn:
            ...
            with st.spinner("Calculating SHAP values..."):
                ...
                st.caption(f"🔍 Debug — pred log-odds: {pred_logodds:.4f} | SHAP log-odds: {shap_logodds:.4f} | base: {base_value:.4f} | sum(SHAP): {np.sum(sv_final):.4f}")
